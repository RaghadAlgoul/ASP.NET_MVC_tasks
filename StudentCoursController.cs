...
using task12_2_2023.Models;

namespace task12_2_2023.Controllers
{
    public class StudentCoursController : Controller
    {
        private MVCtasksEntities2 db = new MVCtasksEntities2();
        ...
        public ActionResult Create([Bind(Include = "StudentID,CourseID,id")] StudentCours studentCours)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,CourseID,id")] StudentCours studentCours)
        {
            if (ModelState.IsValid)
            {
